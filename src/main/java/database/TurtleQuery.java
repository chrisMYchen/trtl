...
public class TurtleQuery {
  ...
  // calc this out later
  public List<Note> getNotes(LatLong loc, double radius) throws SQLException {
    ...
    String getNotes = "SELECT * FROM notes WHERE ? * sinlat + ? * coslat * (coslong* ? + sinlong * ?) > ?;";
  ...
  public void postNote(int userID, int time, double lat, double lng, String text)
      throws SQLException {
